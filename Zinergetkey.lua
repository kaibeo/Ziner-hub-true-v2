...
-- theme
Arqel.Theme = {
    Accent = Color3.fromRGB(255, 200, 0), -- vàng chính
    AccentHover = Color3.fromRGB(255, 220, 50), -- vàng sáng khi hover

    Background = Color3.fromRGB(10, 10, 10), -- đen nền
    Header = Color3.fromRGB(20, 20, 20), -- đen nhạt
    Input = Color3.fromRGB(30, 30, 30),

    Text = Color3.fromRGB(255, 255, 255), -- chữ trắng
    TextDim = Color3.fromRGB(150, 150, 150),

    Success = Color3.fromRGB(50, 205, 110),
    Error = Color3.fromRGB(245, 70, 90),
    Warning = Color3.fromRGB(255, 200, 0), -- vàng

    StatusIdle = Color3.fromRGB(255, 200, 0),
...
local FallbackIcons = {
    ...
    logo = "rbxassetid://136144254602856",
...
local CachedIcons = {}
local FolderName = "Ziner"
local IconsFolder = "Icons"
local DefaultLogoAsset = "rbxassetid://136144254602856"
